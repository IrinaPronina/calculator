                        ...
                        <table className='w-full border-collapse border border-gray-300'>
                            ...
                            <tbody>
                                ...
                                <tr className='bg-gray-50 hover:bg-gray-100'>
                                    <td className='table-td'>0100</td>
                                    <td className='table-td'>
                                        Армирование готовой сеткой
                                    </td>
                                    <td className='table-td'>{area}</td>
                                    <td className='table-td'>м²</td>
                                    <td className='table-td'>
                                ...
                                <tr className='hover:bg-gray-50'>
                                    <td className='table-td'>0155</td>
                                    <td className='table-td'>
                                        Установка маячковых направляющих
                                    </td>
                                    <td className='table-td'>450</td>
                                    <td className='table-td'>м/п</td>
                                    <td className='table-td'>
                                        {formatCurrency(
                                            settingsData.pay.find(
                                                (item) => item.id === '0155'
                                    ...
                                    <td className='table-td'>36 450,00</td>
                                    <td className='table-td text-sm text-gray-600 italic'>
                                        на сварку, съемные
                                    </td>
                                </tr>
                                <tr className='bg-gray-50 hover:bg-gray-100'>
                                    <td className='table-td'>0145</td>
                                    <td className='table-td'>
                                        Укладка бетонной смеси до 100 мм
                                    </td>
                                    <td className='table-td'>{area}</td>
                                    <td className='table-td'>м²</td>
                                    <td className='table-td'>
                                ...
                                <tr className='hover:bg-gray-50'>
                                    <td className='table-td'>0102</td>
                                    <td className='table-td'>
                                        Внесение упрочняющей смеси
                                    </td>
                                    <td className='table-td'>{area}</td>
                                    <td className='table-td'>м²</td>
                                    <td className='table-td'>
                                ...
                                <tr className='bg-gray-50 hover:bg-gray-100'>
                                    ...
                                    <td className='table-td'>
                                        {formatCurrency(Number(area) * 143)}
                                    </td>
                                    <td className='table-td text-sm text-gray-600 italic'>
                                        железнение лопастями
                                    </td>
                                </tr>
                                <tr className='hover:bg-gray-50'>
                                    <td className='table-td'>0140</td>
                                    <td className='table-td'>
                                        Покрытие защитным лаком в 1 слой
                                    </td>
                                    <td className='table-td'>{area}</td>
                                    <td className='table-td'>м²</td>
                                    <td className='table-td'>
                                ...
                                <tr className='bg-gray-50 hover:bg-gray-100'>
                                    <td className='table-td'>0130</td>
                                    <td className='table-td'>
                                        Нарезка усадочных швов
                                    </td>
                                    <td className='table-td'>700</td>
                                    <td className='table-td'>м/п</td>
                                    <td className='table-td'>80,00</td>
                                    <td className='table-td'>56 000,00</td>
                                    <td className='table-td text-sm text-gray-600 italic'>
                                        1/3 от толщины пола
                                    </td>
                                </tr>
                                <tr className='hover:bg-gray-50'>
                                    <td className='table-td'>0109</td>
                                    <td className='table-td'>
                                        Заполнение усадочных швов
                                    </td>
                                    <td className='table-td'>700</td>
                                    <td className='table-td'>м/п</td>
                                    <td className='table-td'>60,00</td>
                                    <td className='table-td'>42 000,00</td>
                                    <td className='table-td text-sm text-gray-600 italic'>
                                        вилатерм с герметиком
                                    </td>
                                </tr>
                                <tr className='bg-gray-50 hover:bg-gray-100'>
                                    <td className='table-td'>0517</td>
                                    <td className='table-td'>
